...
$CONDA_DIR/bin/conda env create -f ../../environment_pyrpl_linux.yml
...
zip pyrpl-linux_x86-$DATE-$LINUX_VER-$GIT_COMMIT_SHORT.zip pyrpl-$DATE-$LINUX_VER-$GIT_COMMIT_SHORT
